...
<Text style={{color:Mycolors.TEXT_COLOR,left:10,top:2}}>Completed Orders</Text>
</View>
...
<Text style={{color:Mycolors.TEXT_COLOR,left:10,top:2}}>Mony Transfer</Text>
</View>

<View style={{flexDirection:'row',marginTop:10}}>
<TouchableOpacity style={{width:25,height:25,backgroundColor:select=='3'? Mycolors.filtercolor : 'transparent',borderRadius:5,justifyContent:'center',borderColor:'gray',borderWidth:1}}
onPress={()=>{setselect('3')}}>
{select=='3' ?
<Image source={require('../../assets/tickw.png')} style={{ width: 15, height: 14,alignSelf:'center'}} />
: null }
</TouchableOpacity>
<Text style={{color:Mycolors.TEXT_COLOR,left:10,top:2}}>Pending Settlement</Text>
</View>
