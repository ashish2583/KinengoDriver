...
const Chat = (props) => {
    ...
    const [userId,setUserId]=useState('');
      useEffect(()=>{
        ...
        removeMessageCount()
        var uid=parseInt(userdetaile.driver_id)
 ...
 const senNoti= async()=>{
        ...
        let notidata={
          'data': {},
          'title':'Message from '+ userdetaile.first_name,
          'body': 'new message',
          'token':mapdata.notificationdata.user_device_id
        } 
         console.log('hiihiiii',notidata)
...
<View style={{width:30,height:30,borderRadius:15,marginHorizontal:10,borderRadius:15,borderWidth:1}}>
<Image source={require('../../assets/images/profileimg.png')} style={{ width: 25, height: 25, alignSelf: 'center',borderRadius:15 }}></Image>
</View>
